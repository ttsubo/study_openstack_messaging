...
class ConsumerBase(object):
    ...
    def __init__(self, channel, callback, tag, **kwargs):
        ...
        """
        LOG.debug("### ConsumerBase.__init__()")
    ...
    def reconnect(self, channel):
        ...
        LOG.debug("### ConsumerBase.reconnect()")
    ...
    def _callback_handler(self, message, callback):
        ...
        """
        LOG.debug("### ConsumerBase._callback_handler()")
    ...
    def consume(self, *args, **kwargs):
        ...
        """
        LOG.debug("### ConsumerBase.consume()")
...
class DirectConsumer(ConsumerBase):
    ...
    def __init__(self, conf, channel, msg_id, callback, tag, **kwargs):
        ...
        """
        LOG.debug("### DirectConsumer.__init__()")
        # Default options
...
class TopicConsumer(ConsumerBase):
    ...
    def __init__(self, conf, channel, topic, callback, tag, exchange_name,
        ...
        """
        LOG.debug("### TopicConsumer.__init__()")
        # Default options
...
class FanoutConsumer(ConsumerBase):
    ...
    def __init__(self, conf, channel, topic, callback, tag, **kwargs):
        ...
        Other kombu options may be passed
        """
        LOG.debug("### FanoutConsumer.__init__()")
...
class DirectPublisher(Publisher):
    ...
    def __init__(self, conf, channel, topic, **kwargs):
        ...
        """
        LOG.debug("### DirectPublisher.__init__()")
...
class TopicPublisher(Publisher):
    ...
    def __init__(self, conf, channel, exchange_name, topic, **kwargs):
        ...
        Kombu options may be passed as keyword args to override defaults
        """
        LOG.debug("### TopicPublisher.__init__()")
        options = {'durable': conf.amqp_durable_queues,
                   'auto_delete': conf.amqp_auto_delete,
                   'exclusive': False}
        options.update(kwargs)
...
class FanoutPublisher(Publisher):
    ...
    def __init__(self, conf, channel, topic, **kwargs):
        ...
        Kombu options may be passed as keyword args to override defaults
        """
        LOG.debug("### FanoutPublisher.__init__()")
        options = {'durable': False,
                   'auto_delete': True,
                   'exclusive': False}
        options.update(kwargs)
...
class NotifyPublisher(TopicPublisher):
    ...
    def __init__(self, conf, channel, exchange_name, topic, **kwargs):
        LOG.debug("### NotifyPublisher.__init__()")
    ...
    def reconnect(self, channel):
        LOG.debug("### NotifyPublisher.reconnect()")
...
class Connection(object):
    ...
    def _disconnect(self):
        LOG.debug("### Connection._disconnect()")
        if self.connection:
    ...
    def get_channel(self):
        ...
        LOG.debug("### Connection.get_channel()")
        return self.channel
    ...
    def declare_consumer(self, consumer_cls, topic, callback):
        ...
        """
        LOG.debug("### Connection.declare_consumer()")
        ...
        def _declare_consumer():
            LOG.debug("### Connection.declare_consumer()._declare_consumer()")
    ...
    def iterconsume(self, limit=None, timeout=None):
        ...
        LOG.debug("### Connection.iterconsume()")
        ...
        def _consume():
            ...
            LOG.debug("### Connection.iterconsume()._consume()")
    ...
    def publisher_send(self, cls, topic, msg, timeout=None, retry=None,
        ...
        LOG.debug("### Connection.publisher_send()")
        ...
        def _publish():
            LOG.debug("### Connection.publisher_send()._publish()")
    ...
    def declare_direct_consumer(self, topic, callback):
        ...
        """
        LOG.debug("### Connection.declare_direct_consumer()")
        self.declare_consumer(DirectConsumer, topic, callback)

    def declare_topic_consumer(self, exchange_name, topic, callback=None,
                               queue_name=None):
        """Create a 'topic' consumer."""
        LOG.debug("### Connection.declare_topic_consumer()")
    ...
    def declare_fanout_consumer(self, topic, callback):
        ...
        LOG.debug("### Connection.declare_fanout_consumer()")
        self.declare_consumer(FanoutConsumer, topic, callback)

    def direct_send(self, msg_id, msg):
        """Send a 'direct' message."""
        LOG.debug("### Connection.direct_send()")
        self.publisher_send(DirectPublisher, msg_id, msg)

    def topic_send(self, exchange_name, topic, msg, timeout=None, retry=None):
        """Send a 'topic' message."""
        LOG.debug("### Connection.topic_send()")
        self.publisher_send(TopicPublisher, topic, msg, timeout,
                            exchange_name=exchange_name, retry=retry)

    def fanout_send(self, topic, msg, retry=None):
        """Send a 'fanout' message."""
        LOG.debug("### Connection.fanout_send()")
    ...
    def notify_send(self, exchange_name, topic, msg, retry=None, **kwargs):
        ...
        LOG.debug("### Connection.notify_send()")
...
class RabbitDriver(amqpdriver.AMQPDriverBase):
    ...
    def __init__(self, conf, url,
        ...
        LOG.debug("### RabbitDriver.__init__()")
