...
class ConnectionPool(pool.Pool):
    ...
    def __init__(self, conf, url, connection_cls):
        LOG.debug("### ConnectionPool.__init__()")
    ...
    def create(self):
        LOG.debug("### ConnectionPool.create()")
        LOG.debug('Pool creating new connection')
        return self.connection_cls(self.conf, self.url)

    def empty(self):
        LOG.debug("### ConnectionPool.empty()")
...
class ConnectionContext(rpc_common.Connection):
    ...
    def __init__(self, conf, url, connection_pool, pooled=True):
        ...
        LOG.debug("### ConnectionContext.__init__()")
    ...
    def __enter__(self):
        ...
        LOG.debug("### ConnectionContext.__enter__()")
        return self
    ...
    def _done(self):
        ...
        """
        LOG.debug("### ConnectionContext._done()")
        if self.connection:
            if self.pooled:
    ...
    def __exit__(self, exc_type, exc_value, tb):
        ...
        LOG.debug("### ConnectionContext.__exit__()")
        self._done()

    def __del__(self):
        """Caller is done with this connection.  Make sure we cleaned up."""
        LOG.debug("### ConnectionContext.__del__()")
        self._done()

    def close(self):
        """Caller is done with this connection."""
        LOG.debug("### ConnectionContext.close()")
        self._done()

    def __getattr__(self, key):
        """Proxy all other calls to the Connection instance."""
        LOG.debug("### ConnectionContext.__getattr__()")
        if self.connection:
