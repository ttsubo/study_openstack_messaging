...
class IncomingMessage(object):
    ...
    def __init__(self, listener, ctxt, message):
        LOG.debug("### IncomingMessage.__init__()")
    ...
    def reply(self, reply=None, failure=None, log_failure=True):
        LOG.debug("### IncomingMessage.reply()")
        "Send a reply or failure back to the client."

    def acknowledge(self):
        LOG.debug("### IncomingMessage.acknowledge()")
        "Acknowledge the message."

    @abc.abstractmethod
    def requeue(self):
        LOG.debug("### IncomingMessage.requeue()")
        "Requeue the message."
...
class Listener(object):
    ...
    def __init__(self, driver):
        LOG.debug("### Listener.__init__()")
        self.conf = driver.conf
        self.driver = driver

    @abc.abstractmethod
    def poll(self, timeout=None):
        LOG.debug("### Listener.poll()")
